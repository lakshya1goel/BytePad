...
import '../../../Services/Details/student_details_for_faculty.dart';
import '../../../Services/authentication/storage.dart';
String? accessToken;
class StudentProfileForFaculty extends StatefulWidget {
  final String roll;
  const StudentProfileForFaculty({super.key, required this.roll});

  @override
  State<StudentProfileForFaculty> createState() => _StudentProfileForFacultyState();
}

class _StudentProfileForFacultyState extends State<StudentProfileForFaculty> {
  ...
  void initState() {
    ...
    secureStorage.readSecureData('accessToken').then((value) {
      ...
      getStudentDetailsForFaculty(accessToken, widget.roll).then((data) {
        setState(() {
          studentDetails = data;
        });
      });
